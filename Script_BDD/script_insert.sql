...
('Esteban', '', 'Doe', 'Esteban', 'esteban@neraudau.fr', 'Dev Full-Stack', 1, 'desert', 0, 5.5, 9, 50, 10, 8754, 549, 1.2, 1),
('Alexandra', '', 'Smith', 'Alexandra', 'alexandra@example.com', 'Business Analyst', 2, 'land', 1, 6.2, 2, 12, 5, 2750, 93, 0.9, 1),
('JulieMartin', '', 'Martin', 'Julie', 'julie.martin@viveris.fr', 'Data Scientist', 5, 'mountain', 2, 0.0, 4, 25, 5, 1620, 30, 0.8, 1),
('LucasDurand', '', 'Durand', 'Lucas', 'lucas.durand@viveris.fr', 'Système d\'Information', 4, 'forest', 0, 6.5, 3, 15, 3, 980, 15, 0.5, 1),
('EmiliePetit', '', 'Petit', 'Emilie', 'emilie.petit@viveris.fr', 'Ingénieur logiciel', 3, 'mountain', 1, 4.2, 5, 40, 7, 2500, 45, 1.1, 1),
('RaphaelLefevre', '', 'Lefevre', 'Raphael', 'raphael.lefevre@viveris.fr', 'Architecte réseau', 2, 'forest', 2, 7.5, 6, 60, 9, 3200, 60, 1.4, 1),
('SophieBertrand', '', 'Bertrand', 'Sophie', 'sophie.bertrand@viveris.fr', 'Chef de projet IT', 1, 'desert', 0, 5.8, 7, 75, 10, 4100, 75, 1.7, 1);
