    ...
    return (user &&
        <div className="creation-form">
            ...
            <div className="row" style={{ marginTop:"20px" }}>
                ...
                <div className="col">
                    <img className="center-picture" src={`../../src/images/profile_picture/profile_picture_${pictureProfile}.png`} alt="Avatar de l'utilisateur" style={{ width: "100%", marginTop: "-10px" }}/>
                </div>
            </div>
