            ...
            {windowWidth < 1105 && userDriver &&
                <div>
                    <div className="row" style={{ marginTop: "-75px"}}>
                        <img className="center-picture" src={`../../src/images/profil_picture_${userDriver.picture_profile}.png`} alt="Photo profil" style={{ width:"150px" }}/>
            ...
            {windowWidth >= 1105 && userDriver &&
                <div>
                    <div className="row" style={{ marginTop: "-145px"}}>
                        <img className="center-picture" src={`../../src/images/profil_picture_${userDriver.picture_profile}.png`} alt="Photo profil" style={{ width:"200px" }}/>
